...
To install <E-commerce Back End>, follow these steps:

This is an SQL and Node project for back end development. The user needs to be familiar with utilizing such technologies.

## Contributing to

To contribute to <E-commerce Back End>, follow these steps:
